...
if __name__ == '__main__':
    sqlAll = "select company_name from job where is_checked != 1 or is_checked is null limit 1;"
    result = mysql.getAll(sqlAll)
    print(result[0]['company_name'])
    execute("scrapy crawl tianyan -a word={}".format(result[0]['company_name']).split())
    # 释放资源
    mysql.dispose()
